...
const SettingsTab = () => {
    ...
    const isActiveWorker = ['graphic_designer', 'web_designer', 'worker', 'designer', 'developer', 'print_specialist', 'video_editor'].includes(role || '');
                            ...
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="bg-surface border border-border rounded-[40px] p-8 md:p-12 space-y-10 shadow-xl">
                                    ...
                                    <div className="bg-surface border border-border rounded-[40px] p-8 md:p-12 space-y-8 shadow-xl">
                                        <h4 className="text-xl font-black text-foreground">Support & Legal</h4>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <button
                                                type="button"
                                                onClick={() => {
                                                    const basePath = role === 'admin' ? '/admin' : isActiveWorker ? '/worker' : '/client';
                                                    navigate(`${basePath}/privacy`);
                                                }}
                                                className="flex items-center justify-between p-6 rounded-[24px] bg-background border border-border hover:border-plaiz-blue/30 hover:bg-plaiz-blue/5 transition-all group text-left"
                                            >
                                                <div className="flex items-center gap-4">
                                                    <div className="w-10 h-10 rounded-xl bg-plaiz-blue/10 flex items-center justify-center text-plaiz-blue group-hover:scale-110 transition-transform">
                                                        <Shield size={20} />
                                                    </div>
                                                    <div>
                                                        <p className="font-bold text-sm text-foreground">Privacy & Security</p>
                                                        <p className="text-[10px] text-muted font-medium mt-0.5">Manage data & safety</p>
                                                    </div>
                                                </div>
                                                <ChevronRight size={16} className="text-muted group-hover:text-plaiz-blue transition-colors" />
                                            </button>
                                            ...
                                            {role !== 'admin' && (
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        const basePath = isActiveWorker ? '/worker' : '/client';
                                                        navigate(`${basePath}/support`);
                                                    }}
                                                    className="flex items-center justify-between p-6 rounded-[24px] bg-background border border-border hover:border-plaiz-cyan/30 hover:bg-plaiz-cyan/5 transition-all group text-left"
                                                >
                                                    <div className="flex items-center gap-4">
                                                        <div className="w-10 h-10 rounded-xl bg-plaiz-cyan/10 flex items-center justify-center text-plaiz-cyan group-hover:scale-110 transition-transform">
                                                            <Zap size={20} />
                                                        </div>
                                                        <div>
                                                            <p className="font-bold text-sm text-foreground">Help & Support</p>
                                                            <p className="text-[10px] text-muted font-medium mt-0.5">Get assistance</p>
                                                        </div>
                                                    </div>
                                                    <ChevronRight size={16} className="text-muted group-hover:text-plaiz-cyan transition-colors" />
                                                </button>
                                            )}
                                        </div>
                                    </div>
