-- FIX AVAILABILITY & PERMISSIONS
-- Run this to fix the "Joining Queue" issue.

-- 1. Redefine the Availability Check with correctly matching logic
...
-- This allows the "Client" to actually run the matches
