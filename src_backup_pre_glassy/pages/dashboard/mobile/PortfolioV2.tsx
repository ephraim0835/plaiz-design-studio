...
const PORTFOLIO_ITEMS = [
    { id: 1, title: 'Luxe Branding System', category: 'Graphic Design', image: 'https://images.unsplash.com/photo-1626785774573-4b799314346d?q=80&w=2670&auto=format&fit=crop', span: 'col-span-2' },
    { id: 2, title: 'Nexus UI Interface', category: 'Web Design', image: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=2574&auto=format&fit=crop', span: 'col-span-1' },
    { id: 3, title: 'Vanguard Print Series', category: 'Printing', image: 'https://images.unsplash.com/photo-1561070791-23c146e99767?q=80&w=2670&auto=format&fit=crop', span: 'col-span-1' },
    { id: 4, title: 'Pulse Web Platform', category: 'Web Design', image: 'https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=2564&auto=format&fit=crop', span: 'col-span-2' },
    { id: 5, title: 'Ethereal Logo Pack', category: 'Graphic Design', image: 'https://images.unsplash.com/photo-1509339022327-1e1e25360a41?q=80&w=2670&auto=format&fit=crop', span: 'col-span-1' },
    { id: 6, title: 'Modern Stationery Kit', category: 'Printing', image: 'https://images.unsplash.com/photo-1586075010633-24701237e370?q=80&w=2574&auto=format&fit=crop', span: 'col-span-1' }
];
