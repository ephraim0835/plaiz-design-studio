            ...
            <header className="relative pt-40 pb-20 lg:pt-64 lg:pb-32 px-6">
                <div className="max-w-6xl mx-auto flex flex-col items-center text-center relative z-10">
                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-surface/60 border border-border rounded-full mb-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 shadow-sm backdrop-blur-md">
                        <img src="/plaiz-logo.png" alt="Plaiz" className="w-3.5 h-3.5 object-contain" />
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-muted">Creative Studio</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-8 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-300">
                        <Link to="/register">
                            <button className="px-14 py-6 bg-foreground text-background rounded-[24px] font-black uppercase tracking-[0.2em] shadow-[0_20px_50px_var(--shadow-color)] hover:scale-[1.05] active:scale-[0.95] transition-all text-xs border border-border">
                                Start a Project
                            </button>
                        </Link>
                        <Link to="/portfolio">
                            <button className="px-14 py-6 bg-surface/60 border border-border text-foreground rounded-[24px] font-black uppercase tracking-[0.2em] hover:bg-surface hover:shadow-xl transition-all text-xs backdrop-blur-md">
                                See Results
                            </button>
                        </Link>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
                        {services.map((service, i) => (
                            <div key={i} className="rounded-[40px] p-3 shadow-sm hover:shadow-2xl hover:-translate-y-4 transition-all duration-700 overflow-hidden flex flex-col group bg-surface border border-border relative">
                                ...
                                <div className="relative aspect-[4/3] rounded-[32px] overflow-hidden mb-8 bg-background">
                                    <img
                                        src={service.image}
                                        alt={service.title}
                                ...
                                <div className="px-8 pb-10 flex flex-col flex-1 relative z-10">
                                    <div className="flex items-center gap-5 mb-6">
                                        <div className="w-14 h-14 rounded-[22px] bg-background text-foreground flex items-center justify-center shadow-xl shadow-black/5 border border-border">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        <div className="relative glass-panel p-3 rotate-1 shadow-2xl group overflow-hidden">
                            <img
                                src="https://images.unsplash.com/photo-1542744173-8e7e5371bb2e?q=80&w=2670&auto=format&fit=crop"
                                className="w-full h-full object-cover rounded-[15px] group-hover:scale-105 transition-transform duration-[5s]"
                                alt="Studio vibe"
                            />
                            <div className="absolute inset-x-8 bottom-8 p-8 glass-panel !bg-black/40 !backdrop-blur-xl border-white/20 text-white">
                                <p className="text-lg font-bold italic mb-6 leading-relaxed">"Better presentation builds trust. Trust creates opportunity. Plaiz helped us look more professional."</p>
