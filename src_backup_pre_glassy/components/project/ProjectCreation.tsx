...
const ProjectCreation: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-background p-6 lg:p-12 flex items-center justify-center relative">
            <button
                onClick={() => navigate(-1)}
                className="absolute top-8 left-8 flex items-center gap-2 text-muted hover:text-foreground transition-all font-black uppercase tracking-widest text-[10px] group"
            >
